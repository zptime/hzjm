...
git_path="/opt/virt/$project_name/git/hbedu_$project_name"
# 待配置项：工程giturl路径,仅首次执行时有用
git_url="ssh://192.168.100.21/data/git/hbedu_$project_name"
# 待配置项：git分支名称
git_branch_name="master"
# 待配置项：启停脚本绝对路径
project_sh_path="$project_path/"
...
cd $project_path
rm -rf media
ln -s /data/hzjmmedia $project_path/media
cd ..
