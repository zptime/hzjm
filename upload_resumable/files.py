...
from hzjm.settings import TMP_DIR
from upload_resumable.err_code import UPLOAD_ERR_PART_SUCCESS, UPLOAD_ERR_COMPLETE_SUCCESS, UPLOAD_ERR_FILE_MD5_ERR_ERR
from upload_resumable.storage.file_storage import FileStorage
from upload_resumable.utils_data import md5sum, generate_file_md5, logger
...
class ResumableFile(object):
    def __init__(self, kwargs, user):
        ...
        must_exist_folder(os.path.join(TMP_DIR, year_str))
